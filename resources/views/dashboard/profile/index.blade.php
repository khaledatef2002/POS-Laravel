...
<x-breadcrumb title="{{ __('site.profile') }}" :path="$path"></x-breadcrumb>

<div class="col-12">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">@lang('site.profile')</h4>
        </div><!-- end card header -->
        ...
        <div class="card-body">
            ...
            <div class="live-preview">
                <form action="{{ route('dashboard.profile') }}" method="post" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    @method('put')
                    <div class="col-lg-12">
