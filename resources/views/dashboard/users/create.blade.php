...
@section('title', __('site.users.add'))
...
<x-breadcrumb title="{{ __('site.users.add') }}" :path="$path"></x-breadcrumb>

<div class="col-12">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">@lang('site.users.add')</h4>
        </div><!-- end card header -->

        <div class="card-body">
            <x-error-alert></x-error-alert>
            <div class="live-preview">
                <form action="{{ route('dashboard.users.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-12">
                            ...
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="avatar-lg p-1">
                                    <div class="avatar-title bg-light rounded-circle">
                                        <img src="{{ asset('assets/dashboard/images/users/user-dummy-img.jpg') }}" id="customer-img" class="avatar-md rounded-circle object-fit-cover">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="first_name" type="text" class="form-control" id="firstname" placeholder="@lang('site.first-name')" value="{{ old('first_name') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="lastname" class="form-label">@lang('site.last-name'):</label>
                        <input name="last_name" type="text" class="form-control" id="lastname" placeholder="@lang('site.last-name')" value="{{ old('last_name') }}">
                    </div>
                    <div class="col-md-12">
                        <label for="email" class="form-label">@lang('site.email'):</label>
                        <input name="email" type="email" class="form-control" id="email" placeholder="@lang('site.email')" value="{{ old('email') }}">
                    </div>
                    <div class="col-md-6">
